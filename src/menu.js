...
PageZipper.prototype.addMenu = function () {
  ...
  var html = `
		<div id='pgzp_menu'>
			...
			<a href='https://o9ll.com/pagezipper' target='_blank' title='PageZipper Home' class='pgzp_block pgzp_button' style='margin-left: -6px'>
				<img src='${pgzp.media_path}32.png' alt='PageZipper!' style='border-width: 0px' />
			</a>
		</div>
	`
