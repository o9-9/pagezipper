/*! URI.js v1.16.0 https://medialize.github.io/URI.js/ */
/* build contains: punycode.js, SecondLevelDomains.js, URI.js */
;(function (h) {
  function k(d) {
    throw RangeError(w[d])
  }
  function r(d, e) {
    for (var f = d.length; f--; ) d[f] = e(d[f])
    return d
  }
  function f(d, H) {
    return r(d.split(e), H).join('.')
  }
  function d(d) {
    for (var e = [], f = 0, l = d.length, a, b; f < l; )
      ((a = d.charCodeAt(f++)),
        55296 <= a && 56319 >= a && f < l
          ? ((b = d.charCodeAt(f++)),
            56320 == (b & 64512)
              ? e.push(((a & 1023) << 10) + (b & 1023) + 65536)
              : (e.push(a), f--))
          : e.push(a))
    return e
  }
  ...
  function n(d, e, f) {
    var l = 0
    d = f ? t(d / 700) : d >> 1
    for (d += t(d / e); 455 < d; l += 36) d = t(d / 35)
    return t(l + (36 * d) / (d + 38))
  }
  function E(d) {
    var e = [],
      f = d.length,
    ...
    0 > g && (g = 0)
    for (m = 0; m < g; ++m)
      (128 <= d.charCodeAt(m) && k('not-basic'), e.push(d.charCodeAt(m)))
    for (g = 0 < g ? g + 1 : 0; g < f; ) {
      m = a
      l = 1
      for (p = 36; ; p += 36) {
          ...
          10 > q - 48
            ...
            : 26 > q - 65
              ...
              : 26 > q - 97
                ? q - 97
                : 36
        ;(36 <= q || q > t((2147483647 - a) / l)) && k('overflow')
        a += q * l
        z = p <= c ? 1 : p >= c + 26 ? 26 : p - c
        if (q < z) break
        q = 36 - z
        l > t(2147483647 / q) && k('overflow')
        l *= q
      }
      l = e.length + 1
      c = n(a - m, l, 0 == m)
      t(a / l) > 2147483647 - b && k('overflow')
      b += t(a / l)
      a %= l
      e.splice(a++, 0, b)
    }
  ...
  function C(e) {
    ...
    h = 0
    b = 72
    for (c = 0; c < z; ++c) ((p = e[c]), 128 > p && q.push(x(p)))
    for ((l = a = q.length) && q.push('-'); l < z; ) {
      g = 2147483647
      for (c = 0; c < z; ++c) ((p = e[c]), p >= f && p < g && (g = p))
      u = l + 1
      g - f > t((2147483647 - h) / u) && k('overflow')
      h += (g - f) * u
      f = g
      for (c = 0; c < z; ++c)
        if (((p = e[c]), p < f && 2147483647 < ++h && k('overflow'), p == f)) {
          m = h
          for (g = 36; ; g += 36) {
            p = g <= b ? 1 : g >= b + 26 ? 26 : g - b
            if (m < p) break
            r = m - p
            m = 36 - p
            q.push(x(y(p + (r % m), 0)))
  ...
  v = {
    version: '1.2.3',
    ucs2: { decode: d, encode: u },
    decode: E,
    encode: C,
    toASCII: function (d) {
      return f(d, function (d) {
        return I.test(d) ? 'xn--' + C(d) : d
      })
    },
    toUnicode: function (d) {
      return f(d, function (d) {
        return G.test(d) ? E(d.slice(4).toLowerCase()) : d
      })
    }
  }
  if (
    ...
    if (F) F.exports = v
    else for (B in v) v.hasOwnProperty(B) && (D[B] = v[B])
  else h.punycode = v
})(this)
;(function (h, k) {
  'object' === typeof exports
    ...
    : 'function' === typeof define && define.amd
      ? define(k)
      : (h.SecondLevelDomains = k(h))
})(this, function (h) {
  var k = h && h.SecondLevelDomains,
    r = {
      list: {
      ...
      get: function (f) {
        ...
        var k = r.list[f.slice(d + 1)]
        return !k || 0 > k.indexOf(' ' + f.slice(h + 1, d) + ' ')
          ? null
          : f.slice(h + 1)
      },
      noConflict: function () {
        h.SecondLevelDomains === this && (h.SecondLevelDomains = k)
        return this
      }
    }
  return r
...
;(function (h, k) {
  'object' === typeof exports
    ...
    : 'function' === typeof define && define.amd
      ? define(['./punycode', './IPv6', './SecondLevelDomains'], k)
      : (h.URI = k(h.punycode, h.IPv6, h.SecondLevelDomains, h))
})(this, function (h, k, r, f) {
  function d(a, b) {
    var c = 1 <= arguments.length,
      g = 2 <= arguments.length
    if (!(this instanceof d)) return c ? (g ? new d(a, b) : new d(a)) : new d()
    if (void 0 === a) {
  ...
  function E(a, b) {
    var c = {},
      d,
      m
    if ('RegExp' === y(b)) c = null
    else if (n(b)) for (d = 0, m = b.length; d < m; d++) c[b[d]] = !0
    else c[b] = !0
    d = 0
  ...
  function C(a, b) {
    ...
    if (n(b)) {
      c = 0
      for (d = b.length; c < d; c++) if (!C(a, b[c])) return !1
      return !0
    }
    var m = y(b)
    c = 0
  ...
  for (x in t)
    ((d[x + 'PathSegment'] = B('pathname', t[x])),
      (d[x + 'UrnPathSegment'] = B('urnpath', t[x])))
  t = function (a, b, c) {
    return function (g) {
      var m
      m = c
        ...
        : d[b]
      g = (g + '').split(a)
      for (var e = 0, f = g.length; e < f; e++) g[e] = m(g[e])
      return g.join(a)
    }
  }
  ...
  d.parseQuery = function (a, b) {
    ...
    if (!a) return {}
    for (var c = {}, g = a.split('&'), m = g.length, e, f, h = 0; h < m; h++)
      if (
        ((e = g[h].split('=')),
  ...
  d.buildQuery = function (a, b, c) {
    ...
    for (e in a)
      if (w.call(a, e) && e)
        if (n(a[e]))
          for (m = {}, f = 0, h = a[e].length; f < h; f++)
            void 0 !== a[e][f] &&
              void 0 === m[a[e][f] + ''] &&
              ((g += '&' + d.buildQueryParameter(e, a[e][f], c)),
              !0 !== b && (m[a[e][f] + ''] = !0))
        else void 0 !== a[e] && (g += '&' + d.buildQueryParameter(e, a[e], c))
  ...
  d.addQuery = function (a, b, c) {
    if ('object' === typeof b)
      for (var g in b) w.call(b, g) && d.addQuery(a, g, b[g])
  ...
  d.removeQuery = function (a, b, c) {
    var g
    if (n(b)) for (c = 0, g = b.length; c < g; c++) a[b[c]] = void 0
    else if ('RegExp' === y(b)) for (g in a) b.test(g) && (a[g] = void 0)
    else if ('object' === typeof b)
      for (g in b) w.call(b, g) && d.removeQuery(a, g, b[g])
    else if ('string' === typeof b)
      void 0 !== c
        ? 'RegExp' === y(c)
          ? !n(a[b]) && c.test(a[b])
  ...
  d.hasQuery = function (a, b, c, g) {
    if ('object' === typeof b) {
      for (var e in b) if (w.call(b, e) && !d.hasQuery(a, e, b[e])) return !1
      return !0
    }
    if ('string' !== typeof b)
      throw new TypeError(
    ...
    switch (y(c)) {
      ...
      case 'Function':
        return !!c(a[b], b, a)
      case 'Array':
        return n(a[b]) ? (g ? C : D)(a[b], c) : !1
      case 'RegExp':
        return n(a[b]) ? (g ? C(a[b], c) : !1) : Boolean(a[b] && a[b].match(c))
      case 'Number':
        c = String(c)
      case 'String':
        return n(a[b]) ? (g ? C(a[b], c) : !1) : a[b] === c
      default:
        throw new TypeError(
  ...
  d.withinString = function (a, b, c) {
    ...
    for (g.lastIndex = 0; ; ) {
      ...
      var l = k + a.slice(k).search(e),
        n = a.slice(k, l).replace(f, '')
      ;(c.ignore && c.ignore.test(n)) ||
        ((l = k + n.length),
        (n = b(n, k, l, a)),
        (a = a.slice(0, k) + n + a.slice(l)),
        (g.lastIndex = k + n.length))
    }
    g.lastIndex = 0
    return a
  }
  ...
  e.href = function (a, b) {
    ...
    !g && e && void 0 !== a.pathname && (a = a.toString())
    if ('string' === typeof a || a instanceof String)
      this._parts = d.parse(String(a), this._parts)
    else if (g || e)
      for (c in ((g = g ? a._parts : a), g))
        w.call(this._parts, c) && (this._parts[c] = g[c])
  ...
  e.is = function (a) {
    ...
    this._parts.hostname &&
      ...
      (b = c || g),
      (f = (e = !b) && r && r.has(this._parts.hostname)),
      (h = e && d.idn_expression.test(this._parts.hostname)),
      (k = e && d.punycode_expression.test(this._parts.hostname)))
  ...
  e.tld = function (a, b) {
    ...
    if (void 0 === a) {
      ...
      return !0 !== b && r && r.list[c.toLowerCase()]
        ? r.get(this._parts.hostname) || c
        : c
    }
    if (a)
  ...
  e.filename = function (a, b) {
    ...
    '/' === a.charAt(0) && (a = a.substring(1))
    a.match(/\.?\//) && (c = !0)
    var g = new RegExp(u(this.filename()) + '$')
    a = d.recodePath(a)
  ...
  e.suffix = function (a, b) {
    ...
    '.' === a.charAt(0) && (a = a.substring(1))
    if ((c = this.suffix()))
      g = a ? new RegExp(u(c) + '$') : new RegExp(u('.' + c) + '$')
    else {
      if (!a) return this
  ...
  e.setQuery = function (a, b, c) {
    ...
    if ('string' === typeof a || a instanceof String)
      ...
      for (var f in a) w.call(a, f) && (e[f] = a[f])
    else
      throw new TypeError(
        'URI.addQuery() accepts an object, string as the name parameter'
      )
  ...
  e.normalizeHostname = function (a) {
    this._parts.hostname &&
      (this.is('IDN') && h
        ? (this._parts.hostname = h.toASCII(this._parts.hostname))
        : this.is('IPv6') &&
          k &&
          (this._parts.hostname = k.best(this._parts.hostname)),
  ...
  e.readable = function () {
    ...
    a._parts.hostname &&
      (a.is('punycode') && h
        ? ((b += h.toUnicode(a._parts.hostname)),
    ...
    if (a._parts.query) {
      for (
        var c = '', e = 0, f = a._parts.query.split('&'), k = f.length;
        e < k;
        e++
      ) {
        var l = (f[e] || '').split('='),
  ...
  e.equals = function (a) {
    ...
    for (h in c)
      if (w.call(c, h)) {
        if (!n(c[h])) {
          if (c[h] !== e[h]) return !1
        } else if (!D(c[h], e[h])) return !1
        f[h] = !0
      }
    for (h in e) if (w.call(e, h) && !f[h]) return !1
    return !0
  }
